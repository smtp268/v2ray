...
# bash <(curl -sL https://git.io/Xray.sh)
...
Documentation=https://github.com/xtls https://git.io/Tony
...
menu() {
    clear
    echo "#############################################################"
    echo -e "# ${YELLOW}✅ Xray一键安装脚本${PLAIN}  😄${PLAIN}       #"
